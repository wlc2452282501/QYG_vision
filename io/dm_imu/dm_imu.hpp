...
{
  uint8_t FrameHeader1; // 1 byte
  uint8_t flag1;  // 1 byte
  uint8_t slave_id1; // 1 byte
  uint8_t reg_acc; // 1 byte
  uint32_t accx_u32; //4 bytes
  uint32_t accy_u32; //4 bytes
  uint32_t accz_u32; //4 bytes
  uint16_t crc1;  //2 bytes
  uint8_t FrameEnd1; // 1 byte
